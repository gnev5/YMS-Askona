...
from sqlalchemy import Integer, String, Boolean, DateTime, ForeignKey, Enum, Time, UniqueConstraint, Date
...
class TimeSlot(Base):
    ...
    __table_args__ = (
        UniqueConstraint("day_of_week", "start_time", "end_time", "dock_id", name="uq_time_slots_unique"),
    )
