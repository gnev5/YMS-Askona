...
def main():
    ...
    print("Все бронирования, пользователи и другие данные будут потеряны.")
    print("Это действие НЕОБРАТИМО!")
    print()
    confirm = input("Вы уверены? Введите 'YES DELETE ALL DATA' для продолжения: ")
    ...
    if not run_command("docker compose exec backend python -m app.setup_database", "Выполнение миграции БД"):
